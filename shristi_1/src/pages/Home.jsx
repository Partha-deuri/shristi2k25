    ...
    const events = [
        {
            title: "Drone Wars",
            description:
                "Witness the clash of drones in an epic aerial battle for supremacy!",
        ...
        },
        {
            ...
            description:
                "Embark on an adventurous quest to solve riddles and uncover hidden treasures!",
        ...
        },
        {
            title: "Hack Shristi",
            description:
                "Showcase your coding prowess and build innovative solutions to real-world challenges.",
        ...
        },
        {
            title: "SUMO ROBO",
            description:
                "Watch robots battle it out in a thrilling sumo-style competition!",
        ...
        },
        {
            title: "CAD IT",
            description:
                "Unleash your creativity and design skills in this exciting CAD modeling contest.",
        ...
        },
        {
            title: "Watt-a-Thon",
            description:
                "Test your engineering skills in this electrifying competition of innovation and energy!",
    ...
    return (
        <div className="relative bg-gradient-to-br from-gray-900 via-black to-gray-800 text-white min-h-screen flex flex-col max-w-full overflow-hidden">
          ...
          `}
                ...
                <section className="relative flex flex-col justify-center items-center text-center h-screen max-w-full overflow-hidden">
                    ...
                    <div className="relative z-10 px-6 animate-fade-in">
                        ...
                        <p className="text-xl text-gray-300 max-w-2xl">
                            Welcome to SHRISTI – where innovation, technology,
                        ...
                        <div className="mt-6 flex justify-center gap-4">
                            <Link
                                to="/events"
                                className="px-6 py-3 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-lg text-lg font-semibold hover:shadow-lg hover:scale-105 transition-transform"
                            >
                                Explore Events
                            </Link>
                            <Link
                                to="/game"
                                className="hidden lg:block px-6 py-3 bg-gradient-to-r from-green-500 to-lime-500 rounded-lg text-lg font-semibold hover:shadow-lg hover:scale-105 transition-transform"
                            >
                                Play Game
                            </Link>
                            <Link
                                to="/signup"
                                className="px-6 py-3 bg-gradient-to-r from-indigo-600 to-blue-500 rounded-lg text-lg font-semibold hover:shadow-lg hover:scale-105 transition-transform"
                            >
                                Register Now
                            </Link>
                        </div>
                ...
                {/* Promo Video Section */}
                <section className="relative flex flex-col justify-center items-center text-center h-[80vh]">
                    <div className="bg-black h-full w-[80vw] rounded-lg">
                        <video
                            id="promoVideo"
                    ...
                    <button
                        ...
                        className="absolute bottom-4 right-4 p-3 bg-gray-800 bg-opacity-70 text-white rounded-full hover:bg-gray-700 transition cursor-pointer"
                    >
                        <span id="muteIcon" className="text-2xl">
                            🔇
                        </span>
                    </button>
                </section>
                ...
                <section
                    ...
                    style={{
                        backgroundImage:
                            "linear-gradient(to bottom, rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url('/path-to-about-image.jpg')",
                        backgroundSize: "cover",
                        backgroundPosition: "center",
                    }}
                >
                    ...
                    <div className="relative z-10 px-6 animate-slide-up">
                        ...
                        <p className="text-lg text-gray-300 max-w-2xl">
                            Shristi is the annual technical fest of NERIST,
                            bringing together the best minds in technology,
